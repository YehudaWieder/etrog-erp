...
export class AuthController {
  ...
  @Public()
  @Post('login')
  @ApiOperation({ summary: 'Login with email and password and receive JWT access token' })
  @ApiBody({
    schema: {
      type: 'object',
      required: ['email', 'password'],
      properties: {
        email: { type: 'string', format: 'email', example: 'owner@etrog-erp.com' },
  ...
  @Post('logout')
  @ApiOperation({ summary: 'Logout current user (JWT stateless logout acknowledgment)' })
