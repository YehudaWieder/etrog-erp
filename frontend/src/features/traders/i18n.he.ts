...
export const TRADER_INVENTORY_I18N_HE: TraderInventoryI18n = {
	...
	summary: {
		...
		filters: {
			...
			inventorySourceLabel: 'מקור מלאי',
			inventorySourceAllOption: 'הכל',
			inventorySourceGeneralOption: 'כללי',
...
export const TRADER_CATEGORIES_I18N_HE: TraderCategoriesI18n = {
	...
	groupNamePlaceholder: 'שם הקבוצה (לדוגמה: פרימיום)',
	...
	shareCondition: {
		sectionTitle: 'חלוקה לפי תנאי',
		addButton: 'הוספת תנאי חלוקה',
		editButton: 'עריכה',
		disableButton: 'כיבוי',
		enableButton: 'הפעלה',
		deleteButton: 'מחיקה',
		deleteBlockedTooltip: 'לא ניתן למחוק תנאי שכבר יש לו היסטוריית מלאי. ניתן רק לכבות אותו.',
		statusActiveBadge: 'פעיל',
		statusDisabledBadge: 'כבוי',
		statusEndedBadge: 'הסתיים',
		summaryDateRangeOpenEnded: (start) => `מ-${start} וללא תאריך סיום`,
		summaryDateRange: (start, end) => `מ-${start} עד ${end}`,
		summaryQuantityThreshold: (qty) => `עד ${qty} יחידות שחולקו`,
		summarySharesBreakdown: (breakdown) => breakdown,
		popupAddTitle: 'הגדרת חלוקה לפי תנאי',
		popupEditTitle: 'עריכת תנאי חלוקה',
		nameLabel: 'שם התנאי',
		namePlaceholder: 'שם התנאי',
		statusLabel: 'סטטוס',
		statusActiveOption: 'פעיל',
		statusDisabledOption: 'כבוי',
		startDateLabel: 'תאריך התחלה',
		endDateLabel: 'תאריך סיום (לא חובה)',
		endDateOptionalHint: 'אם לא מוגדר, התנאי לא יסתיים לפי תאריך',
		quantityThresholdLabel: 'סף כמות (לא חובה)',
		quantityThresholdPlaceholder: 'כמות שאחריה התנאי מסתיים',
		quantityThresholdOptionalHint: 'אם לא מוגדר, התנאי לא יסתיים לפי כמות',
		endConditionModeLabel: 'תנאי הסיום מתקיים כאשר',
		endConditionModeEitherOption: 'אחד מהתנאים מתקיים (תאריך או כמות)',
		endConditionModeBothOption: 'שני התנאים מתקיימים יחד (תאריך וכמות)',
		sharesTitle: 'פירוט חלוקה לפי התנאי',
		popupCancel: 'ביטול',
		popupSave: 'שמירה',
		missingName: 'יש להזין שם לתנאי.',
		missingStartDate: 'יש לבחור תאריך התחלה.',
		invalidDateRange: 'תאריך הסיום חייב להיות אחרי תאריך ההתחלה.',
		missingEndCondition: 'יש להגדיר לפחות תנאי סיום אחד: תאריך סיום או סף כמות.',
		overlappingCondition: (name) => `טווח התאריכים חופף לתנאי הפעיל הקיים "${name}". יש לכבות או לשנות את התנאי האחר קודם.`,
	},
};
...
export const TRADER_MOVEMENTS_I18N_HE: TraderMovementsI18n = {
	...
	addMovementForm: {
		...
		typeOptions: {
			...
			RECLASSIFICATION: 'שינוי סיווג ושיוך',
			RECLASSIFICATION_MANAGE: 'עדכון / ביטול שינוי סיווג ושיוך',
		},
		fromTraderLabel: 'מסוחר',
		toTraderLabel: 'לסוחר',
		assignedDestinationLabel: 'יעד ההקצאה',
		assignedDestinationPlaceholder: 'בחר יעד הקצאה',
		assignedDestinationOptions: { GENERAL: 'כללי (לפי אחוזים)' },
		assignGeneralInsufficientStockError: 'אין מספיק מלאי לא-משויך זמין לביצוע ההקצאה המבוקשת.',
		assignGeneralCannotSplitError: 'לא ניתן לחלק את הכמות המבוקשת בהגינות בין כל הסוחרים — נסה כמות אחרת.',
		traderLabel: 'סוחר',
		...
		reclassificationSourceLabel: 'מקור המלאי לשינוי סיווג ושיוך',
		reclassificationSourcePlaceholder: 'בחר מקור',
		reclassificationSourceOptions: {
			SPECIFIC_TRADER: 'מלאי פרטי',
			GENERAL: 'כללי',
			REMAINS_IN_ITALY: 'נשאר באיטליה',
		},
		reclassificationFromLabel: 'מ-',
		reclassificationToLabel: 'ל-',
		reclassificationRemainsInItalyGradeHLabel: 'דרגה ה\' נשארת באיטליה',
		reclassificationRemainsInItalyGradeVLabel: 'דרגה ו\' נשארת באיטליה',
		reclassificationOwnershipLabel: 'שיוך',
		reclassificationOwnershipPlaceholder: 'בחר שיוך',
		reclassificationOwnershipGeneralOption: 'כללי',
		reclassificationAvailableLabel: (quantity: number) => `כמות זמינה לשינוי סיווג ושיוך: ${quantity}`,
		reclassificationExceedsAvailableError: (quantity: number) => `הכמות שהוזנה עולה על הכמות הזמינה לשינוי סיווג ושיוך (${quantity}).`,
		reclassificationInsufficientStockError: 'אין מספיק מלאי זמין לביצוע שינוי הסיווג והשיוך המבוקש.',
		reclassificationSameTupleError: 'הסיווג החדש זהה לסיווג הישן - אין שינוי לבצע.',
		reclassificationUndoBatchLabel: 'שינוי סיווג ושיוך לניהול',
		reclassificationUndoBatchPlaceholder: 'בחר שינוי סיווג ושיוך קיים...',
		reclassificationUndoNoBatches: 'אין שינויי סיווג ושיוך זמינים לניהול.',
		reclassificationUndoLoading: 'טוען שינויי סיווג ושיוך קיימים...',
		reclassificationManageUpdateLabel: 'עדכון',
		reclassificationManageCancelLabel: 'ביטול שינוי סיווג ושיוך',
		reclassificationManageCancelingLabel: 'מבטל...',
		...
		cancelRequiresFullAvailabilityLabel: 'לא ניתן לבטל - חלק מהכמות כבר נארז. ניתן לבטל רק כאשר כל הכמות זמינה.',
