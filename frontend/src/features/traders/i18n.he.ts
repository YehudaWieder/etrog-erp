...
export const TRADER_MOVEMENTS_I18N_HE: TraderMovementsI18n = {
	...
	addMovementForm: {
		...
		typeOptions: {
			...
			PITAM_SPLIT_UNDO: 'ביטול סיווג מעורב',
		},
		...
		pitamSplitUndoBatchLabel: 'סיווג מעורב לביטול',
		pitamSplitUndoBatchPlaceholder: 'בחר סיווג לביטול',
		pitamSplitUndoNoBatches: 'אין סיווגי מעורב זמינים לביטול.',
		pitamSplitUndoLoading: 'טוען סיווגים...',
