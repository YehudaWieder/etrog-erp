...
export const TRADER_MOVEMENTS_I18N_HE: TraderMovementsI18n = {
	...
	addMovementForm: {
		...
		typeOptions: {
			...
			RECLASSIFICATION: 'שינוי סיווג',
			RECLASSIFICATION_MANAGE: 'עדכון / ביטול שינוי סיווג',
		},
		...
		reclassificationSourceLabel: 'מקור המלאי לשינוי סיווג',
		...
		reclassificationAvailableLabel: (quantity: number) => `כמות זמינה לשינוי סיווג: ${quantity}`,
		reclassificationExceedsAvailableError: (quantity: number) => `הכמות שהוזנה עולה על הכמות הזמינה לשינוי סיווג (${quantity}).`,
		reclassificationInsufficientStockError: 'אין מספיק מלאי זמין לביצוע שינוי הסיווג המבוקש.',
		reclassificationSameTupleError: 'הסיווג החדש זהה לסיווג הישן - אין שינוי לבצע.',
		reclassificationUndoBatchLabel: 'שינוי סיווג לניהול',
		reclassificationUndoBatchPlaceholder: 'בחר שינוי סיווג קיים...',
		reclassificationUndoNoBatches: 'אין שינויי סיווג זמינים לניהול.',
		reclassificationUndoLoading: 'טוען שינויי סיווג קיימים...',
		reclassificationManageUpdateLabel: 'עדכון',
		reclassificationManageCancelLabel: 'ביטול שינוי סיווג',
