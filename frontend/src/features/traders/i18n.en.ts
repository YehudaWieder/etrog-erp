...
export const TRADER_INVENTORY_I18N_EN: TraderInventoryI18n = {
	...
	summary: {
		...
		filters: {
			...
			inventorySourceAllOption: 'All',
			inventorySourceGeneralOption: 'General',
...
export const TRADER_CATEGORIES_I18N_EN: TraderCategoriesI18n = {
	...
	shareCondition: {
		sectionTitle: 'Conditional Distribution',
		addButton: 'Add distribution condition',
		editButton: 'Edit',
		disableButton: 'Disable',
		enableButton: 'Enable',
		deleteButton: 'Delete',
		deleteBlockedTooltip: 'Cannot delete a condition that already has inventory history. You can only disable it.',
		statusActiveBadge: 'Active',
		statusDisabledBadge: 'Disabled',
		statusEndedBadge: 'Ended',
		summaryDateRangeOpenEnded: (start) => `From ${start}, no end date`,
		summaryDateRange: (start, end) => `From ${start} to ${end}`,
		summaryQuantityThreshold: (qty) => `Up to ${qty} units distributed`,
		summarySharesBreakdown: (breakdown) => breakdown,
		popupAddTitle: 'Set up a conditional distribution',
		popupEditTitle: 'Edit distribution condition',
		nameLabel: 'Condition name',
		namePlaceholder: 'Condition name',
		statusLabel: 'Status',
		statusActiveOption: 'Active',
		statusDisabledOption: 'Disabled',
		startDateLabel: 'Start date',
		endDateLabel: 'End date (optional)',
		endDateOptionalHint: 'If not set, the condition will not end by date',
		quantityThresholdLabel: 'Quantity threshold (optional)',
		quantityThresholdPlaceholder: 'Quantity after which the condition ends',
		quantityThresholdOptionalHint: 'If not set, the condition will not end by quantity',
		endConditionModeLabel: 'The end condition is met when',
		endConditionModeEitherOption: 'Either condition is met (date or quantity)',
		endConditionModeBothOption: 'Both conditions are met together (date and quantity)',
		sharesTitle: 'Distribution breakdown for this condition',
		popupCancel: 'Cancel',
		popupSave: 'Save',
		missingName: 'Please enter a name for the condition.',
		missingStartDate: 'Please select a start date.',
		invalidDateRange: 'The end date must be after the start date.',
		missingEndCondition: 'Please set at least one end condition: end date or quantity threshold.',
		overlappingCondition: (name) => `The date range overlaps with the existing active condition "${name}". Disable or adjust the other condition first.`,
	},
};
...
export const TRADER_MOVEMENTS_I18N_EN: TraderMovementsI18n = {
	...
	addMovementForm: {
		...
		typeOptions: {
			...
			RECLASSIFICATION: 'Reclassification & Ownership',
			RECLASSIFICATION_MANAGE: 'Update / Cancel Reclassification & Ownership',
		},
		fromTraderLabel: 'From Trader',
		toTraderLabel: 'To Trader',
		assignedDestinationLabel: 'Assignment Destination',
		assignedDestinationPlaceholder: 'Select assignment destination',
		assignedDestinationOptions: { GENERAL: 'General (by percentage)' },
		assignGeneralInsufficientStockError: 'Not enough unassigned stock available to perform the requested assignment.',
		assignGeneralCannotSplitError: 'The requested quantity cannot be fairly split across all traders — try a different quantity.',
		traderLabel: 'Trader',
		...
		reclassificationSourceLabel: 'Stock Source for Reclassification & Ownership',
		...
		reclassificationOwnershipLabel: 'Ownership',
		reclassificationOwnershipPlaceholder: 'Select ownership',
		reclassificationOwnershipGeneralOption: 'General',
		...
		reclassificationInsufficientStockError: 'Not enough stock available to perform this reclassification & ownership change.',
		reclassificationSameTupleError: 'The new classification is identical to the old one - there is nothing to change.',
		reclassificationUndoBatchLabel: 'Reclassification & Ownership to Manage',
		reclassificationUndoBatchPlaceholder: 'Select an existing reclassification & ownership change...',
		reclassificationUndoNoBatches: 'No existing reclassifications & ownership changes to manage.',
		reclassificationUndoLoading: 'Loading existing reclassifications & ownership changes...',
		reclassificationManageUpdateLabel: 'Update',
		reclassificationManageCancelLabel: 'Cancel Reclassification & Ownership',
		...
		cancelRequiresFullAvailabilityLabel: 'Cannot cancel - part of this quantity is already packed. Cancellation is only allowed while the full quantity is available.',
