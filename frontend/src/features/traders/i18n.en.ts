...
export const TRADER_MOVEMENTS_I18N_EN: TraderMovementsI18n = {
	...
	addMovementForm: {
		...
		typeOptions: {
			...
			PITAM_SPLIT_UNDO: 'Undo Mixed Resolution',
		},
		...
		pitamSplitUndoBatchLabel: 'Mixed Resolution to Undo',
		pitamSplitUndoBatchPlaceholder: 'Select a resolution to undo',
		pitamSplitUndoNoBatches: 'No mixed resolutions available to undo.',
		pitamSplitUndoLoading: 'Loading resolutions...',
