...
export type TraderCategoriesI18n = {
	...
	shareCondition: {
		...
		statusDisabledBadge: string;
		statusEndedBadge: string;
		summaryDateRangeOpenEnded: (start: string) => string;
		summaryDateRange: (start: string, end: string) => string;
		summaryQuantityThreshold: (qty: number) => string;
		summarySharesBreakdown: (breakdown: string) => string;
		popupAddTitle: string;
		popupEditTitle: string;
		nameLabel: string;
		namePlaceholder: string;
		statusLabel: string;
		statusActiveOption: string;
		statusDisabledOption: string;
		startDateLabel: string;
		endDateLabel: string;
		endDateOptionalHint: string;
		quantityThresholdLabel: string;
		quantityThresholdPlaceholder: string;
		quantityThresholdOptionalHint: string;
		endConditionModeLabel: string;
		endConditionModeEitherOption: string;
		endConditionModeBothOption: string;
		sharesTitle: string;
		popupCancel: string;
		popupSave: string;
		missingName: string;
