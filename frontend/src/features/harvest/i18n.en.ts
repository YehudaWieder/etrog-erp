...
export const HARVEST_I18N_EN: HarvestI18n = {
  ...
  bulkForm: {
    ...
    existingClassificationCellBlockedHint: 'This cell is blocked because a sorting entry with the same assignment, category, grade and pitam status already exists.',
