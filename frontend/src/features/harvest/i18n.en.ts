...
export const HARVEST_I18N_EN: HarvestI18n = {
  ...
  bulkForm: {
    ...
    existingClassificationCellBlockedHint: 'This cell is blocked because a sorting entry with the same assignment, category, grade and pitam status already exists. Click the edit icon to update the existing quantity - the change is saved together with the rest of the table when you click save.',
    blockedQuantityFieldsHint: 'Some fields are blocked because of unsupported grades or sorting entries that already exist for them. You can edit the existing sorting entry.',
    editExistingClassificationCellLabel: 'Edit existing quantity',
    cancelExistingClassificationCellLabel: 'Revert to original quantity',
