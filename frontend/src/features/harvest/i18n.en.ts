...
export const HARVEST_I18N_EN: HarvestI18n = {
  ...
  topNav: [
    ...
    { id: 'partners', label: 'Trader Inventory', icon: 'fa-handshake', href: '/traders' },
  ...
  dailyDetails: {
    ...
    summary: {
      ...
      uncalculatedRejected: 'Uncalculated Rejected',
      harvestExcludingBadPicks: 'Harvest Excluding Bad Picks',
      rejectedExcludingBadPicks: 'Rejected Excluding Bad Picks',
      totalNet: 'Total Net',
    },
    detailsPanel: {
      ...
      fields: {
        ...
        harvestExcludingBadPicks: 'Harvest Excluding Bad Picks',
        badPickQuantity: 'Bad Pick Quantity',
      },
      values: {
        partial: 'Partial',
        final: 'Final',
