...
export const HARVEST_I18N_HE: HarvestI18n = {
  ...
  bulkForm: {
    ...
    addSortingRowSummaryFieldsRequiredError: 'יש למלא את שדות הסיכום של סה"כ קטיף וסה"כ פסולים לפני הוספת שורת מיון.',
  ...
  formSubmission: {
    ...
    totalRejectedRequired: 'יש להזין סה"כ פסולים.',
    ...
    addSortingRowTotalsRequiredError: 'יש להזין סה"כ קטיף וסה"כ פסולים לפני הוספת שורת מיון.',
    addSortingRowSummaryFieldsRequiredError: 'יש למלא את שדות הסיכום של סה"כ קטיף וסה"כ פסולים לפני הוספת שורת מיון.',
