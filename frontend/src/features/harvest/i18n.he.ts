...
export const HARVEST_I18N_HE: HarvestI18n = {
  ...
  bulkForm: {
    ...
    existingClassificationCellBlockedHint: 'תא זה חסום כי כבר קיימת רשומת מיון עם אותו שיוך, קטגוריה, דרגה וסטטוס פיטם. ניתן ללחוץ על סמל העריכה כדי לעדכן את הכמות הקיימת - השינוי יישמר יחד עם שאר הטבלה בלחיצה על שמירה.',
    blockedQuantityFieldsHint: 'חלק מהשדות חסומים עקב דרגות לא נתמכות או מיונים שכבר קיימים להם. ניתן לערוך את המיון הקיים.',
    editExistingClassificationCellLabel: 'עריכת כמות קיימת',
    cancelExistingClassificationCellLabel: 'ביטול השינוי לכמות המקורית',
