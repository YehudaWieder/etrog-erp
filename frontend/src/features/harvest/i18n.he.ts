...
export const HARVEST_I18N_HE: HarvestI18n = {
  ...
  bulkForm: {
    ...
    existingClassificationCellBlockedHint: 'תא זה חסום כי כבר קיימת רשומת מיון עם אותו שיוך, קטגוריה, דרגה וסטטוס פיטם.',
    blockedQuantityFieldsHint: 'חלק מהשדות חסומים עקב דרגות לא נתמכות או מיונים שכבר קיימים להם. ניתן לערוך את המיון הקיים.',
    cancel: 'ביטול',
    save: 'שמירת קטיף',
    saving: 'שומר...',
  },
