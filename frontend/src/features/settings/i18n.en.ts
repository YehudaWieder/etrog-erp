...
export const SETTINGS_I18N_EN: SettingsI18n = {
  ...
  sidebarManager: [
    ...
    },
    {
      ...
      icon: 'fa-leaf',
      items: [
        { id: 'harvestSellersFields', label: 'Sellers/Fields', href: '/settings/israel-harvest/sellers-fields', icon: 'fa-user-tie' },
        { id: 'harvestSellerCategories', label: 'Seller Categories', href: '/settings/israel-harvest/seller-categories', icon: 'fa-tag' },
        { id: 'harvestSortingCategories', label: 'Sorting Categories', href: '/settings/israel-harvest/sorting-categories', icon: 'fa-layer-group' },
        { id: 'harvestCategoryGrades', label: 'Category Grades', href: '/settings/israel-harvest/grades', icon: 'fa-star' },
      ],
    },
  ],
  content: {
