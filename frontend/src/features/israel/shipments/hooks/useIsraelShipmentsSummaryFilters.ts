...
type UseIsraelShipmentsSummaryFiltersResult = {
...
export function useIsraelShipmentsSummaryFilters(
  labels: IsraelShipmentItemsSummaryTableLabels,
): UseIsraelShipmentsSummaryFiltersResult {
