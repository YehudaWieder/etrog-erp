...
import styles from './styles/NewShipmentFormModal.module.css';

type NewShipmentFormModalText = {
  title: string;
  description: string;
...
type NewShipmentFormModalProps = {
  isOpen: boolean;
  t: NewShipmentFormModalText;
...
export function NewShipmentFormModal({
  isOpen,
  t,
  shipmentNumber,
  ...
  onSave,
  onClose,
}: NewShipmentFormModalProps): JSX.Element | null {
  if (!isOpen) {
    return null;
  }
