export const SHIPMENTS_I18N_HE = {
  ...
  tableLabels: {
    ...
    detailsBoxesSummary: {
      ...
      totalRowLabel: 'סה"כ',
      totalColumnLabel: 'סה"כ קרטונים',
      etrogTotalColumnLabel: 'סה"כ אתרוגים',
  ...
  boxesTableLabels: {
    ...
    tableExportError: 'ייצוא נכשל. נסה שוב.',
    tableStandardPrintOption: 'הדפסה רגילה',
    tableExtendedPrintOption: 'הדפסה מורחבת',
    tableStandardExportOption: 'הורדה רגילה',
    tableExtendedExportOption: 'הורדה מורחבת',
    tableExtendedPrintTitle: 'פירוט פריטים לפי קרטון',
    tableExtendedExportError: 'ייצוא מורחב נכשל. נסה שוב.',
  },
