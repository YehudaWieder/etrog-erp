export const SHIPMENTS_I18N_EN = {
  ...
  newShipmentItemModal: {
    ...
    addExistingItemQuantityLabel: 'Add quantity',
    cancelExistingItemEditLabel: 'Cancel the added quantity',
    addExistingItemQuantityPopupTitle: 'Add quantity to existing item',
    ...
    addExistingItemQuantityPopupInstruction: "Enter the quantity you'd like to add to this item.",
