export const SHIPMENTS_I18N_EN = {
  ...
  boxesTableLabels: {
    ...
    tableExportError: 'Export failed. Please try again.',
    tableStandardPrintOption: 'Standard print',
    tableExtendedPrintOption: 'Extended print',
    tableStandardExportOption: 'Standard download',
    tableExtendedExportOption: 'Extended download',
    tableExtendedPrintTitle: 'Item breakdown by box',
    tableExtendedExportError: 'Extended export failed. Please try again.',
  },
