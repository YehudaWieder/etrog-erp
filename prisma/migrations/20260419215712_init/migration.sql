...
-- CreateIndex
CREATE UNIQUE INDEX "Shipment_seasonId_id_key" ON "Shipment"("seasonId", "id");
...
-- CreateIndex
CREATE UNIQUE INDEX "Box_shipmentId_boxNumber_key" ON "Box"("shipmentId", "boxNumber");
...
-- CreateIndex
CREATE UNIQUE INDEX "ShipmentItem_boxId_traderCategoryId_customerCategoryId_grad_key" ON "ShipmentItem"("boxId", "traderCategoryId", "customerCategoryId", "grade", "pitamStatus", "ownershipType", "traderId", "customerId");
